...
export function MediaUploader({ postType, cfg, mediaFiles, allMedia, styleSettings, updateStyle, fileRefs, handleFileChange, removeMedia, addExtraSlot, isVertical }) {
  if (postType === 'story') {
    return (
      <StoryCanvas
        cfg={cfg}
    ...
    <>
      {postType === 'carousel' ? (
        ...
        >
          {mediaFiles[0] ? (
            <>
              {/* FIX: use isVideoMedia for reliable video detection */}
