    ...
    >
      <div
        ...
        style={{
          ...
          height: 'calc(min(100dvh, 100vh) - 24px)',
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginTop: 3 }}>
                    <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.82)', fontWeight: 500, lineHeight: 1.3, overflowWrap: 'break-word', wordBreak: 'break-word' }}>
              ...
              {caption && (
                <div style={{ marginBottom: 8 }}>
                  <div style={{ fontSize: 14, color: '#fff', lineHeight: 1.45, textShadow: '0 1px 4px rgba(0,0,0,0.6)', overflowWrap: 'break-word', wordBreak: 'break-word' }}>
              ...
              {post.hashtags && (
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.75)', marginBottom: 4, lineHeight: 1.4, overflowWrap: 'break-word', wordBreak: 'break-word' }}>
                  {post.hashtags}
                </div>
              )}
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', gap: 18, flexShrink: 0, paddingBottom: 2 }}>
              {actions.map(({ icon, label, key }) => (
                <div key={key} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                  ...
                  {label && (
                    <span style={{ fontSize: 11, fontWeight: 700, color: '#fff', textShadow: '0 1px 4px rgba(0,0,0,0.8)', textAlign: 'center', maxWidth: 52, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {label}
                    </span>
                  )}
                </div>
