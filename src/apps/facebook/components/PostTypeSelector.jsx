...
export default function PostTypeSelector({ onSelectType, onClose }) {
  return (
    <div
      className="fb-post-type-selector"
      style={{
      background: '#fff',
      borderRadius: 16,
      ...
      {/* Header row */}
      <div className="fb-post-type-header" style={{ display: 'flex', alignItems: 'center', marginBottom: 20 }}>
