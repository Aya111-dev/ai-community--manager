        ...
        <div style={{ height: mediaHeight, minHeight: isStory || isReel ? '100vh' : 420, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#050505' }}>
          {primaryMedia.src ? (
            isVideo ? (
              ...
              <img src={primaryMedia.src} alt="" style={{ width: '100%', height: '100%', objectFit: isStory || isReel ? mediaStyle.objectFit : 'contain', objectPosition: mediaStyle.objectPosition, transform: mediaStyle.transform }} />
            )
