      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', background: '#fff', height: '100%' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px', minHeight: 0 }}>
            ...
            <div style={{ padding: '10px 0', borderTop: `1px solid ${FB_BORDER}`, borderBottom: `1px solid ${FB_BORDER}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, fontSize: 13, color: FB_SECONDARY, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0, whiteSpace: 'nowrap' }}>
                <span style={{ width: 20, height: 20, borderRadius: '50%', background: FB_BLUE, color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><ThumbsUp size={11} /></span>
