    ...
    <div onClick={e => e.stopPropagation()}
      ...
      <div style={{ minHeight: 0, display: 'flex', flexDirection: 'column', background: '#fff', borderLeft: post.media?.length && !stacked ? `1px solid ${FB_BORDER}` : 'none', maxHeight: stacked ? 'min(40vh, 320px)' : 'none' }}>
        ...
        <div style={{ padding: stacked ? '12px 12px 8px' : '14px 14px 10px', overflowY: 'auto', flex: 1 }}>
          ...
          <div style={{ marginTop: 18, paddingBottom: 14, borderBottom: `1px solid ${FB_BORDER}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 13, color: FB_SECONDARY, gap: 12, flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ width: 20, height: 20, borderRadius: '50%', background: FB_BLUE, color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 12 }}><ThumbsUp size={12} /></span>
