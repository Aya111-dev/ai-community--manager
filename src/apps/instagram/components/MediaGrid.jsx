...
const MediaGrid = ({
  ...
  maxMedia = 5,
  mediaRenderKey = 0,
  visibleSlots: controlledVisibleSlots,
  ...
  const [internalVisibleSlots, setInternalVisibleSlots] = useState(3);
  const visibleSlots = controlledVisibleSlots ?? internalVisibleSlots;
  const setVisibleSlots = onVisibleSlotsChange ?? setInternalVisibleSlots;
                ...
                <>
                  ...
                  >
                    {mediaItem.kind === 'video' ? (
                      <PreviewVideo
                        key={`${mediaItem.id || mediaItem.url}-${mediaRenderKey}`}
                        src={mediaItem.url}
